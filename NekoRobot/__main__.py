...
buttons = [
    [
        InlineKeyboardButton(
            text=f" {BOT_NAME} ✨ 𝐀ᴅᴅ ᴍᴇ ᴛᴏ ʏᴏᴜʀ ɢʀᴏᴜᴘ ✨",
            url=f"https://telegram.dog/{BOT_USERNAME}?startgroup=true",
        )
    ],
    [
        InlineKeyboardButton(text="⛩ 𝐂ᴏᴍᴍᴀɴᴅs ⛩", callback_data="help_back"),
        InlineKeyboardButton(
            text="♪ 𝐌ᴜsɪᴄ ♪", callback_data="settings_back_helper"),
        
    ],
    [
        InlineKeyboardButton(
            text="🥀 𝐒ᴜᴘᴘᴏʀᴛ 🥀", url=f"https://telegram.dog/{SUPPORT_CHAT}"
        ),
        InlineKeyboardButton(
            text="❄️ 𝐔ᴘᴅᴀᴛᴇs ❄️", url="https://telegram.dog/TSO_UPDATES"
        ),
    ],
]
HELP_STRINGS = """
*ᴍᴀɴᴀɢᴇᴍᴇɴᴛ 🤖*\n\nNᴏᴡ ʏᴏᴜ ᴄᴀɴ sᴇᴇ ᴍʏ ᴀʟʟ ᴍᴏᴅᴜʟᴇs ᴀɴᴅ ᴄᴏᴍᴍᴀɴᴅs Aʟʟ ᴄᴏᴍᴍᴀɴᴅs ᴄᴀɴ ʙᴇ ᴜsᴇᴅ ᴡɪᴛʜ : /
"""
                ...
                send_help(
                    ...
                    InlineKeyboardMarkup(
                        [
                            [
                                InlineKeyboardButton(
                                    text="𝐁ᴀᴄᴋ", callback_data="help_back"
                                )
                            ]
                        ]
                    ),
                ...
                reply_markup=InlineKeyboardMarkup(
                    [
                        [
                            ...
                            InlineKeyboardButton(
                                text="𝐒ᴜᴘᴘᴏʀᴛ", url=f"https://t.me/{SUPPORT_CHAT}"
                            ),
                        ]
                    ]
                ),
    ...
    try:
        if mod_match:
            ...
            kbrd = InlineKeyboardMarkup(
                InlineKeyboardButton(text="ʙᴀᴄᴋ", callback_data=f"stngs_back({chat_id}")
            )
...
def get_settings(update: Update, context: CallbackContext) -> None:
    ...
    if chat.type == chat.PRIVATE:
        ...
        text = "ᴄʟᴏᴄᴋ ʜᴇʀᴇ ᴛᴏ ᴄʜᴇᴄᴋ ʏᴏᴜ sᴇᴛᴛɪɴɢs"
